...
<div class="cover-container container-fluid d-flex p-3 flex-column w-100" style="background-image: url('${pageContext.request.contextPath}/resources/img/fondo.jpg'); background-repeat: repeat repeat-y">
