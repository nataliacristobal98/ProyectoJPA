...
<div class="cover-container d-flex p-3 flex-column w-100" style="background-image: url('${pageContext.request.contextPath}/resources/img/fondo.jpg');">
  ...
  <main class="p-3 mt-5 mb-3 rounded-3 text-center w-50" style="background-color: rgba(255,255,255,0.61); margin-inline: auto;">
    <form action="${mvc.basePath}/signup/signup" method="post" class="w-50" style="margin-inline: auto;">
      ...
      <div class="text-start">
        ...
        <input class="form-control" id="nombre" name="nombre" placeholder="Ej: Rosario Martinez Garcia" required>
      </div>
      <div class="text-start">
      ...
      <button class="w-75 btn btn-lg mt-3" style="background-color: #f7a365; color: #ffffff;border-color: #E38B00FF" type="submit">Registrarse</button>
