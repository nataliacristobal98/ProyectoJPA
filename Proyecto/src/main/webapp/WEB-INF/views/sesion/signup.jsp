    ...
    <div class="text-dark">
      ...
      <nav class="nav nav-masthead float-md-end">
        ...
        <a class="nav-link" aria-current="page" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi bi-globe2"
               viewBox="0 0 16 16">
            <path
        ...
        <a href="#" class="nav-link text-white">
          <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" class="bi bi-person-video2"
               viewBox="0 0 16 16">
  ...
  <main class="px-3 form-signin text-center">
    <form action="${mvc.basePath}/signup/signup" method="post">
      ...
      <div class="form-floating">
        <input class="form-control" id="nombre" name="nombre" placeholder="Nombre Apellido">
      ...
      <button class="w-100 btn btn-lg btn-danger mt-3" type="submit">Registrarse</button>

      <p class="mt-5 mb-3 text-muted">¿Ya tienes cuenta? <a href="${mvc.basePath}/login"
                                                            class="text-danger">Inicia Sesión</a></p>
    </form>
  </main>
</div>
