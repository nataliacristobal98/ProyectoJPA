...
<div class="cover-container d-flex p-3 flex-column w-100">
    ...
    <main class="px-3 form-signin text-center">
        <form action="${mvc.basePath}/login/login" method="post">
            ...
            <div class="form-floating">
                <input class="form-control" id="floatingInput" name="codigo" placeholder="A001">
                <label for="floatingInput">Código de alumno</label>
            </div>
            <div class="form-floating">
